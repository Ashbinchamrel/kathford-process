...
<div class="space-y-4">
    <form method="GET" class="bg-white rounded-xl border border-gray-200 p-4 grid grid-cols-1 sm:grid-cols-4 gap-3">
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search action or label…"
               class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 outline-none">
        <input type="text" name="action" value="<?php echo e(request('action')); ?>" placeholder="Action filter (e.g. user.created)…"
               class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 outline-none">
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-5 py-3 text-xs text-gray-400 whitespace-nowrap"><?php echo e($log->logged_at->format('d M Y H:i')); ?></td>
                        <td class="px-5 py-3 text-gray-700"><?php echo e($log->user?->name ?? 'System'); ?></td>
                        <td class="px-5 py-3">
                            <span class="font-mono text-xs bg-gray-100 px-1.5 py-0.5 rounded"><?php echo e($log->action); ?></span>
                        </td>
                        <td class="px-5 py-3 text-gray-600 text-xs"><?php echo e($log->model_label); ?></td>
                        <td class="px-5 py-3 font-mono text-xs text-gray-400"><?php echo e($log->ip_address); ?></td>
                        <td class="px-5 py-3 text-right">
                            <a href="<?php echo e(route('admin.audit-logs.show', $log)); ?>" class="text-teal-600 hover:text-teal-700 text-sm font-medium">Details</a>
                        </td>
                    </tr>
        ...
        <?php if($logs->hasPages()): ?>
            <div class="px-5 py-3 border-t border-gray-100"><?php echo e($logs->withQueryString()->links()); ?></div>
        <?php endif; ?>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ashbinkumarchamrel/Downloads/kathford-process/resources/views/admin/audit-logs/index.blade.php ENDPATH**/ ?>