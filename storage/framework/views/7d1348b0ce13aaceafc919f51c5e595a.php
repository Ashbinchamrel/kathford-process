<?php $__env->startSection('title', 'Edit ' . $form->form_number); ?>
<?php $__env->startSection('page-title', 'Edit ' . $form->form_number); ?>
...
?>
<div class="max-w-4xl" x-data="formBuilder(<?php echo e($lineItemsJson); ?>, <?php echo e($showReason); ?>, <?php echo e($showLogistics); ?>, <?php echo \Illuminate\Support\Js::from($budgetOptions)->toHtml() ?>, '<?php echo e(old('budget_id', $form->budget_id)); ?>')">

    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('activity_forms.edit')): ?>
<form method="POST" action="<?php echo e(route('activity-forms.update', $form)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
<input type="hidden" name="_fiscal_year_id" value="<?php echo e($workingFiscalYear?->id); ?>"> <?php echo method_field('PUT'); ?>

        <?php if($errors->any()): ?><div class="rounded-xl bg-red-50 text-red-800 p-4 mb-4 text-sm"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><p><?php echo e($error); ?></p><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div><?php endif; ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 mb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <select name="category_id" x-model="categoryId" @change="showReason=categories[categoryId].requires_reason; showLogistics=categories[categoryId].requires_logistic_table" required class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm"><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Department</label>
                    <select name="department_id" x-model="departmentId" @change="budgetId=''" required class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm"><?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($department->id); ?>"><?php echo e($department->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="deadline_date" value="<?php echo e(old('deadline_date', $form->deadline_date?->format('Y-m-d'))); ?>" required
                ...
                <div x-show="showReason">
                    ...
                    <textarea name="unplanned_reason" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 outline-none resize-none"><?php echo e(old('unplanned_reason', $form->unplanned_reason)); ?></textarea>
                </div>
                <div class="sm:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                    <textarea name="remarks" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 outline-none resize-none"><?php echo e(old('remarks', $form->remarks)); ?></textarea>
                </div>
            </div>
        </div>
...
<a href="<?php echo e(route('activity-forms.show', $form)); ?>" class="text-gray-500 hover:text-gray-700 text-sm ml-auto py-2.5">Cancel</a>
<?php endif; ?>
        </div>
    </form>
<?php endif; ?>
...
function formBuilder(initialItems, showReason, showLogistics, budgets, initialBudgetId) {
    return {
        ...
        categoryId: <?php echo \Illuminate\Support\Js::from(old('category_id', $form->category_id))->toHtml() ?>,
        departmentId: <?php echo \Illuminate\Support\Js::from(old('department_id', $form->department_id))->toHtml() ?>,
        categories: <?php echo \Illuminate\Support\Js::from($categories->keyBy('id'))->toHtml() ?>,
        budgetSearch: '',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ashbinkumarchamrel/Downloads/kathford-process/resources/views/activity-forms/edit.blade.php ENDPATH**/ ?>