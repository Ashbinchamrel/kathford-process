<?php $__env->startSection('title', 'Save Recovery Codes'); ?>
...
<div class="bg-gray-900 rounded-xl p-5 mb-6 font-mono text-sm grid grid-cols-2 gap-2">
    <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <span class="text-green-400 tracking-widest"><?php echo e($code); ?></span>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ashbinkumarchamrel/Downloads/kathford-process/resources/views/auth/2fa-recovery-codes.blade.php ENDPATH**/ ?>