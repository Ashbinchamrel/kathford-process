...
<title><?php echo e($notification->message); ?></title>
<style>
...
<div class="wrapper">
    ...
    <div class="footer">
        &copy; <?php echo e(date('Y')); ?> Kathford International College · This is an automated notification.
    </div>
</div>
</body>
</html>
<?php /**PATH /Users/ashbinkumarchamrel/Downloads/kathford-process/resources/views/emails/notification.blade.php ENDPATH**/ ?>