            ...
            <div class="space-y-4"><template x-for="(item,index) in items" :key="item.key">
                <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 space-y-3">
                    ...
                    <div class="flex flex-wrap gap-3 items-center">
                        @if($preparationRfq)<label class="text-sm" x-show="item.source_line_item_id"><input type="checkbox" :name="`items[${index}][quotation_not_required]`" value="1" x-model="item.quotation_not_required" @change="item.vendor_rate_id=''"> Quotation Not Required</label>@endif
