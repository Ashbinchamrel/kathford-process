...
<div class="max-w-5xl space-y-5">
    ...
    @php($relatedActivityForm = $checklist->purchaseOrder?->rfqQuote?->rfq?->activityForm)
...
<a href="{{ route('checklists.activity-form.pdf', $checklist) }}" target="_blank" class="mt-2 inline-block text-sm font-semibold text-teal-700">Download Activity Form →</a>
@endif
</div></div>
